...
class BookDetailsViewController: UIViewController {
    ...
    func setupView(){
        ...
        if book.assigned{
            ...
            detailView.text = "\(String(describing: book.title!)) by \(String(describing: book.author!))  is assigned to: \(String(describing: regID))"
            }
...
extension BookDetailsViewController{
    ...
    func returnBooks(){
        datacontrol.viewContext.delete(book.assignedTo!)
            book.assigned = false
